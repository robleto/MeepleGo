...
const starWarsResults = ultimateSearchWithDebug(
  mockGames,
  'star wars outer rim',
  5
)
...
const starWarsGenericResults = ultimateSearchWithDebug(
  mockGames,
  'star wars',
  5
)
console.log(
  'Results:',
  starWarsGenericResults.map((g) => g.name)
)
