    ...
    <PageLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{mech.name}</h1>
            <p className="text-gray-600">Games using this mechanic</p>
          </div>
          <Link href="/mechanics" className="text-sm text-primary-600 hover:underline">All Mechanics →</Link>
        </div>
        {games.length === 0 && (
          <div className="rounded-lg border border-gray-200 bg-white p-6 text-center text-sm text-gray-500">No games found for this mechanic.</div>
        )}
