  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <ul>
          <li>
            Account details like email address for authentication and
            notifications.
          </li>
          <li>
            Profile and app content you create, such as lists, rankings, awards.
          </li>
        ...
        <ul>
          ...
          <li>
            Send transactional emails (confirmations, password resets) via our
            email provider.
          </li>
        ...
        <p>
          We retain data for as long as your account is active or as required by
