  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none">
        <p>
          By using MeepleGo, you agree to these terms. Please read them
          carefully.
        </p>
        ...
        <ul>
          ...
          <li>
            Don’t misuse the service or attempt to access it using methods other
            than provided interfaces.
          </li>
        </ul>
        <h2>Content</h2>
        <p>
          You retain rights to content you submit. You grant us a license to
          host and display it in the app.
        </p>
        <h2>Termination</h2>
