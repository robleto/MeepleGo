...
export default function RankingsEmptyStateGames({
  isGuest,
  onSignupClick,
  onLoginClick,
}: RankingsEmptyStateGamesProps) {
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-2xl px-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">
          Build Your Game Rankings
        </h1>
        <p className="text-gray-600 mb-8">
          Rate games 1–10, track what you've played, and later generate yearly
          award winners from your personal taste.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm mb-10">
          ...
          <div>
            ...
            <p className="text-gray-500">
              See your highest rated games by year.
            </p>
          </div>
          <div>
            <h4 className="font-semibold mb-1">3. Create Awards</h4>
            <p className="text-gray-500">
              Crown yearly favorites (coming soon).
            </p>
          </div>
        </div>
          ...
          {isGuest && (
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-4 py-3 rounded-md border border-gray-300 bg-white text-gray-800 text-sm font-medium hover:bg-gray-50"
              >
                Sign Up
              </button>
              <button
                onClick={onLoginClick}
                className="px-4 py-3 rounded-md border border-gray-200 bg-gray-50 text-gray-700 text-sm font-medium hover:bg-gray-100"
              >
                Log In
              </button>
            </div>
