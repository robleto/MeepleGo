...
const meta: Meta<typeof Logo> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'The MeepleGo brand logo component with consistent styling across different sizes and contexts. Can be used with or without text, and as a clickable link or static element.'
      }
    }
  },
  tags: ['autodocs'],
