...
export default function ListExplorer({
  ...
  const hasExplicitListOrder = showListRanking
  const {
    hasMounted,
    sortBy, setSortBy,
  ...
  return (
    <div className="space-y-6">
      ...
      <GameFilters
        ...
        loading={loading}
        error={error || null}
        // Keep defaults benign; ordering is preserved by disabling client sort.
        defaults={{ viewMode:'grid', sortBy:'name', sortOrder:'asc', groupBy:'none', filterType:'none', filterValue:'all' }}
      />
        ...
        <div key={key} className="mb-8">
          ...
          {viewMode==='grid' ? (
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              ...
              const rank = (showListRanking && (game as any).__listRanking != null) ? (game as any).__listRanking : (showListRanking ? (idx + 1) : null)
              return (
