          ...
          <div className="relative h-24 bg-gray-100">
            <div className="absolute inset-0 flex items-center justify-center -top-6">
              {[0, 1, 2].map((idx) => (
                <div
                  key={idx}
                  className="absolute w-16 h-20 bg-gray-200 rounded-xl border-2 border-white shadow-lg"
                  style={{
  ...
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm animate-pulse min-h-[320px] flex flex-col items-center text-center"
        >
          {/* Icon circle */}
