...
const mockGame = {
  ...
  year_published: 2019,
  image_url:
    'https://cf.geekdo-images.com/yLZJCVLlIx4c7eJEWUNJ7w__itemrep@2x/img/veohwKEtFpERbDq7xGMggHqLKX8=/fit-in/492x600/filters:strip_icc()/pic4458123.jpg',
  thumbnail_url:
    'https://cf.geekdo-images.com/yLZJCVLlIx4c7eJEWUNJ7w__itemrep@2x/img/veohwKEtFpERbDq7xGMggHqLKX8=/fit-in/492x600/filters:strip_icc()/pic4458123.jpg',
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Three information density levels for different use cases
        </p>
    ...
    <div className="space-y-8">
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">
          Overlay States (Balanced Density)
        </h3>
        <p className="text-sm text-gray-600">
          Different overlay combinations at standard density
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          How overlays work at compact density level
        </p>
