...
const grouped: GroupedSuggestions = {
  exactMatches: [{ id:1, name:'Wingspan', year_published:2019, rating:8.1, thumbnail_url:null }],
  popular: [{ id:2, name:'Gloomhaven', year_published:2017, rating:8.7, thumbnail_url:null }],
  other: [{ id:3, name:'Wing Leader', year_published:2014, rating:7.0, thumbnail_url:null }]
};
