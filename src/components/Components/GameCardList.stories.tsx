...
const meta: Meta<typeof GameCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'List view density variants with standardized right-side actions (Played / Own It / Wishlist / Rating).',
      },
    },
  },
}
...
const wishlistGame = {
  ...
  ranking: { ...baseGame.ranking, played_it: false, ranking: null },
}
const neutralGame = {
  ...baseGame,
  id: 'g3',
  ...
  ranking: { ...baseGame.ranking, ranking: null, played_it: false },
}
const bothGame = {
  ...baseGame,
  id: 'g4',
  name: 'Brass: Birmingham',
  list_membership: { library: true, wishlist: true },
  ranking: { ...baseGame.ranking, ranking: 9 },
}
...
export const ListBalanced: Story = {
...
export const ActionStates: Story = {
  ...
  render: () => (
    <div className="space-y-3 p-6 max-w-4xl">
      ...
      />
      <GameCard
        game={wishlistGame as any}
        viewMode="list"
        variant="balanced"
        listRank={3}
      />
      <GameCard
        game={neutralGame as any}
        viewMode="list"
        variant="balanced"
        listRank={4}
      />
