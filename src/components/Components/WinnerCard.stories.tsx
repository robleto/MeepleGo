...
const mockGame: GameWithRanking = {
  ...
  year_published: 2019,
  image_url:
    'https://cf.geekdo-images.com/yLZJCVLlIx4c7eJEWUNJ7w__original/img/cI782Zis9cT66B6hPiOqSctGx6A=/0x0/filters:format(jpeg)/pic4458123.jpg',
  thumbnail_url:
    'https://cf.geekdo-images.com/yLZJCVLlIx4c7eJEWUNJ7w__thumb/img/Af1LtVfOmd_4PF6BJTM-2U-y8E0=/fit-in/200x150/filters:strip_icc()/pic4458123.jpg',
