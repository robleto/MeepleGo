 ...
 */
export default function TimelineMarker({ year, isLast = false, className = '' }: TimelineMarkerProps) {
  return (
    <div className={`relative flex flex-col items-center w-12 md:w-24 shrink-0 ${className}`}>
      {/* Vertical line */}
      <div
