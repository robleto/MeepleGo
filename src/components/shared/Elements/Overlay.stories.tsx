...
const meta: Meta<typeof Overlay> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible overlay component for modals, dropdowns, and background overlays. Supports different opacity levels, blur effects, and click-to-close functionality.'
      }
    }
  },
  argTypes: {
  ...
  args: {
    children: (
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md mx-4">
        ...
        <p className="text-gray-600">This is a basic overlay with dark background.</p>
      </div>
    ),
  },
}
  ...
  render: () => {
    ...
    return (
      <div className="p-8 space-y-4">
        <h3 className="text-lg font-semibold">Click buttons to see different overlay variants:</h3>
        ...
        <div className="mt-8 p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg">
          <h4 className="text-xl font-bold text-gray-800 mb-2">Sample Content</h4>
          <p className="text-gray-600">This content will be covered by the overlay. Notice how different variants affect visibility.</p>
          <div className="mt-4 grid grid-cols-3 gap-4">
            {Array.from({ length: 6 }, (_, i) => (
              <div key={i} className="h-20 bg-gradient-to-br from-pink-200 to-yellow-200 rounded"></div>
            ))}
          </div>
        </div>
        ...
        >
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md mx-4">
            ...
            <p className="text-gray-600 mb-4">Classic dark semi-transparent background.</p>
            <button 
        ...
        >
          <div className="bg-gray-800 text-white rounded-lg shadow-xl p-6 max-w-md mx-4">
            ...
            <p className="text-gray-300 mb-4">Light semi-transparent background, great for dark content.</p>
            <button 
              onClick={() => setActiveOverlay(null)}
        ...
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl p-6 max-w-md mx-4 border">
            ...
            <p className="text-gray-600 mb-4">Backdrop blur effect for modern glass-morphism look.</p>
            <button 
              onClick={() => setActiveOverlay(null)}
              className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
            >
        ...
        >
          <div className="bg-white rounded-lg shadow-2xl p-6 max-w-md mx-4 border-2 border-purple-200">
            ...
            <p className="text-gray-600 mb-4">No background, just positioning. Content shows through.</p>
            <button 
              onClick={() => setActiveOverlay(null)}
              className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700"
            >
  ...
  render: () => {
    ...
    return (
      <div className="p-8">
        ...
        >
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md mx-4">
            <h3 className="text-lg font-semibold mb-2">Click Outside to Close</h3>
            <p className="text-gray-600 mb-4">
              This overlay can be closed by clicking outside the content area or using the button below.
            </p>
            <button 
      ...
      <div className="p-8">
        ...
        <div className="max-w-sm bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-4">
            ...
            <p className="text-gray-600 text-sm mb-3">A competitive bird-collection, engine-building game</p>
            <button 
              onClick={() => setVisible(true)}
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div><strong>Players:</strong> 1-5</div>
                    <div><strong>Age:</strong> 10+</div>
                    <div><strong>Play Time:</strong> 40-70 minutes</div>
                    <div><strong>Designer:</strong> Elizabeth Hargrave</div>
                  </div>
                </div>
              </div>
            </div>
...
export const PositionVariants: Story = {
  render: () => (
    <div className="relative h-96 bg-gray-100 p-8 overflow-hidden">
      ...
      <p className="text-gray-600 mb-4">This container shows absolute positioning vs fixed.</p>
      
      <div className="relative h-48 bg-white rounded-lg border-2 border-dashed border-gray-300 p-4">
        <p className="text-sm text-gray-500">Relative container for absolute overlay</p>
