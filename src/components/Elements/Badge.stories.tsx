...
const meta: Meta<typeof Badge> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A versatile badge component for labels, status indicators, and notifications. Includes a specialized WinnerBadge variant for awards.',
      },
    },
  },
  argTypes: {
...
export const WithIcons: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3">
      ...
      <Badge variant="warning" icon={<ExclamationTriangleIcon />}>
        Warning
      </Badge>
      <Badge variant="error" icon={<XCircleIcon />}>
        Error
      </Badge>
      <Badge variant="info" icon={<InformationCircleIcon />}>
        Info
      </Badge>
  ...
  render: () => (
    <div className="space-y-4">
      <div className="flex flex-wrap gap-2">
        <Badge variant="success" subtle icon={<CheckCircleIcon />}>
          Owned
        </Badge>
        <Badge variant="warning" subtle>
          Wishlist
...
export const WinnerBadges: Story = {
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        <WinnerBadge type="winner" size="md">
          Game of the Year
        </WinnerBadge>
        <WinnerBadge type="nominee" size="sm">
          Best Family Game
        </WinnerBadge>
        <WinnerBadge type="special" size="lg">
          Editor's Choice
        </WinnerBadge>
      </div>

      <div className="flex flex-wrap gap-3">
        <WinnerBadge type="winner" shape="pill">
          Spiel des Jahres
        </WinnerBadge>
        <WinnerBadge type="nominee" shape="square">
          BGG Golden Geek
        </WinnerBadge>
      </div>
    </div>
