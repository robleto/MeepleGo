...
export default function StatCard({
  ...
  const baseClasses =
    'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 flex flex-col justify-between min-h-[100px] transition-all duration-200'
