...
const meta: Meta<typeof SearchInput> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Airbnb-style search input with integrated round search/clear button. Includes focus states, backdrop blur, and accessibility features for autocomplete scenarios.'
      }
    }
  },
  argTypes: {
...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-6">
      ...
      <div className="max-w-md mx-auto">
        <p className="text-sm font-medium mb-2 text-center">Medium (max-w-md)</p>
        <SearchInput
          value=""
          onChange={() => {}}
