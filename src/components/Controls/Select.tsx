    ...
    return (
      <div className="relative">
        {leftIcon && (
          <div
            className={cn(
              'absolute inset-y-0 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 z-10',
              iconPosition[size]
            )}
          >
        ...
        <select
          ref={ref}
          className={cn(
            'w-full border rounded-md shadow-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors focus:outline-none appearance-none cursor-pointer',
            sizeClasses[size],
            iconPadding[size],
            'pr-8',
            stateClasses[state],
