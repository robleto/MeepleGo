...
export function FilterButton({
  ...
  const baseStyles =
    'relative flex items-center gap-2 px-4 py-2 rounded-full border transition-colors disabled:opacity-50 disabled:cursor-not-allowed'

  const variantStyles = {
    default: 'border-gray-300 bg-white hover:bg-gray-50 text-gray-900',
    primary:
      'border-primary-300 bg-primary-50 hover:bg-primary-100 text-primary-900',
