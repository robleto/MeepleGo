...
const MAJOR_AWARDS = [
  ...
  },
  {
    ...
    honors: [
      {
        name: '2023 Spiel des Jahres Winner',
        year: 2023,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2022 Spiel des Jahres Winner',
        year: 2022,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2021 Spiel des Jahres Winner',
        year: 2021,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2020 Spiel des Jahres Winner',
        year: 2020,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2019 Spiel des Jahres Winner',
        year: 2019,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2018 Spiel des Jahres Winner',
        year: 2018,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      ...
      {
        name: '2015 Golden Geek Best Family Board Game Winner',
        year: 2015,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2015 Spiel des Jahres Nominee',
        year: 2015,
        category: 'Nominee',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year nomination from Germany',
      },
      {
        name: '2014 Golden Geek Best Family Board Game Winner',
        year: 2014,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2013 Golden Geek Best Card Game Winner',
        year: 2013,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Card Game from BoardGameGeek community',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    honors: [
      {
        name: '2011 Kennerspiel des Jahres Winner',
        year: 2011,
        category: 'Winner',
        award_type: 'Kennerspiel des Jahres',
        description: 'Connoisseur Game of the Year from Germany',
      },
      {
        name: '2010 Golden Geek Best Strategy Board Game Winner',
        year: 2010,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2009 Spiel des Jahres Winner',
        year: 2009,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
      ...
      {
        name: '2008 Golden Geek Best Strategy Board Game Winner',
        year: 2008,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
  ...
  // === KENNERSPIEL DES JAHRES WINNERS ===
  {
    ...
    honors: [
      {
        name: '2022 Kennerspiel des Jahres Winner',
        year: 2022,
        category: 'Winner',
        award_type: 'Kennerspiel des Jahres',
        description: 'Connoisseur Game of the Year from Germany',
      ...
      {
        name: '2021 Golden Geek Board Game of the Year Winner',
        year: 2021,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2020 Golden Geek Best Family Board Game Winner',
        year: 2020,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2017 Kennerspiel des Jahres Nominee',
        year: 2017,
        category: 'Nominee',
        award_type: 'Kennerspiel des Jahres',
        description: 'Connoisseur Game of the Year nomination from Germany',
      },
      {
        name: '2016 Golden Geek Best Strategy Board Game Winner',
        year: 2016,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
      ...
      {
        name: '2016 Golden Geek Best Solo Board Game Winner',
        year: 2016,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Solo Board Game from BoardGameGeek community',
      },
    ],
  },
  ...
  // === GOLDEN GEEK BOARD GAME OF THE YEAR WINNERS ===
  {
    ...
    honors: [
      {
        name: '2017 Golden Geek Board Game of the Year Winner',
        year: 2017,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
      ...
      {
        name: '2017 Golden Geek Best Strategy Board Game Winner',
        year: 2017,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
      ...
      {
        name: '2017 Golden Geek Best Thematic Board Game Winner',
        year: 2017,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Thematic Board Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2018 Golden Geek Best Abstract Board Game Winner',
        year: 2018,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Abstract Board Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2015 Golden Geek Board Game of the Year Winner',
        year: 2015,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
  ...
  // === CLASSIC SPIEL DES JAHRES WINNERS ===
  {
    ...
    honors: [
      ...
      {
        name: '1996 Origins Award for Best Fantasy or Science Fiction Board Game Winner',
        year: 1996,
        category: 'Winner',
        award_type: 'Origins Award',
        description: 'Best Fantasy or Science Fiction Board Game',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2001 Spiel des Jahres Winner',
        year: 2001,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
      ...
      {
        name: '2000 International Gamers Award - General Strategy: Two-players Winner',
        year: 2000,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Two-players category',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2004 Spiel des Jahres Winner',
        year: 2004,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
      ...
      {
        name: '2004 Origins Award for Best Board Game Winner',
        year: 2004,
        category: 'Winner',
        award_type: 'Origins Award',
        description: 'Best Board Game',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2004 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2004,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
      },
    ],
  },
  ...
  // === COOPERATIVE GAMES ===
  {
    ...
    honors: [
      {
        name: '2009 Golden Geek Best Family Board Game Winner',
        year: 2009,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
      ...
      {
        name: '2008 Golden Geek Best Cooperative Game Winner',
        year: 2008,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Cooperative Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2001 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2001,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
  ...
  // === STRATEGY GAMES ===
  {
    ...
    honors: [
      {
        name: '2011 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2011,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
      ...
      {
        name: '2011 Golden Geek Best Strategy Board Game Nominee',
        year: 2011,
        category: 'Nominee',
        award_type: 'Golden Geek',
        description:
          'Best Strategy Board Game nomination from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2008 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2008,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
      ...
      {
        name: '2007 Golden Geek Best Strategy Board Game Winner',
        year: 2007,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2006 Golden Geek Best Strategy Board Game Winner',
        year: 2006,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
      ...
      {
        name: '2005 International Gamers Award - General Strategy: Two-players Winner',
        year: 2005,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Two-players category',
  ...
  // === RECENT ACCLAIMED GAMES ===
  {
    ...
    honors: [
      {
        name: '2018 Golden Geek Board Game of the Year Winner',
        year: 2018,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
      ...
      {
        name: '2018 Golden Geek Best Strategy Board Game Winner',
        year: 2018,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
  ...
  // === PARTY GAMES ===
  {
    ...
    honors: [
      {
        name: '2010 Golden Geek Best Party Board Game Winner',
        year: 2010,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Party Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '1999 Origins Award for Best Traditional Card Game Winner',
        year: 1999,
        category: 'Winner',
        award_type: 'Origins Award',
        description: 'Best Traditional Card Game',
      },
    ],
  },
  ...
  // === ENGINE BUILDERS ===
  {
    ...
    honors: [
      {
        name: '2013 Golden Geek Best Strategy Board Game Winner',
        year: 2013,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Strategy Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2016 Golden Geek Board Game of the Year Winner',
        year: 2016,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
      ...
      {
        name: '2016 Golden Geek Best Innovative Board Game Winner',
        year: 2016,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Innovative Board Game from BoardGameGeek community',
      },
    ],
  },
  ...
  },
  {
    ...
    honors: [
      {
        name: '2008 Golden Geek Best Family Board Game Winner',
        year: 2008,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
  ...
  // === DECK BUILDERS ===
  {
    ...
    honors: [
      {
        name: '2009 Golden Geek Best Card Game Winner',
        year: 2009,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Card Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2016 Golden Geek Best Card Game Winner',
        year: 2016,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Card Game from BoardGameGeek community',
  ...
  // === MORE SPIEL DES JAHRES CLASSICS ===
  {
    ...
    honors: [
      {
        name: '2010 Spiel des Jahres Winner',
        year: 2010,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2007 Spiel des Jahres Winner',
        year: 2007,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2006 Spiel des Jahres Winner',
        year: 2006,
        category: 'Winner',
        award_type: 'Spiel des Jahres',
        description: 'Game of the Year award from Germany',
  ...
  // === ABSTRACT STRATEGY ===
  {
    ...
    honors: [
      {
        name: '2001 Mensa Select Winner',
        year: 2001,
        category: 'Winner',
        award_type: 'Mensa Select',
        description: 'Mensa Select award for mind games',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '1935 Games Hall of Fame',
        year: 1935,
        category: 'Special',
        award_type: 'Games Hall of Fame',
        description: 'Inducted into Games Magazine Hall of Fame',
      },
    ],
  },
  ...
  // === WARGAMES ===
  {
    ...
    honors: [
      {
        name: '2004 International Gamers Award - Historical Simulation Winner',
        year: 2004,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'Historical Simulation category',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2007 Golden Geek Best Wargame Winner',
        year: 2007,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Wargame from BoardGameGeek community',
      },
    ],
  },
  ...
  // === EURO GAMES ===
  {
    ...
    honors: [
      {
        name: '2000 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2000,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2007 International Gamers Award - General Strategy: Multi-player Winner',
        year: 2007,
        category: 'Winner',
        award_type: 'International Gamers Award',
        description: 'General Strategy Multi-player category',
  ...
  // === MODERN CLASSICS ===
  {
    ...
    honors: [
      {
        name: '2015 Golden Geek Best 2-Player Board Game Winner',
        year: 2015,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best 2-Player Board Game from BoardGameGeek community',
      },
    ],
  },
  {
    ...
    honors: [
      {
        name: '2012 Golden Geek Best 2-Player Board Game Winner',
        year: 2012,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best 2-Player Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2011 Golden Geek Best Thematic Board Game Winner',
        year: 2011,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Thematic Board Game from BoardGameGeek community',
  ...
  // === RECENT HITS ===
  {
    ...
    honors: [
      {
        name: '2020 Golden Geek Best Cooperative Game Winner',
        year: 2020,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Cooperative Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2020 Kennerspiel des Jahres Winner',
        year: 2020,
        category: 'Winner',
        award_type: 'Kennerspiel des Jahres',
        description: 'Connoisseur Game of the Year from Germany',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2019 Kennerspiel des Jahres Winner',
        year: 2019,
        category: 'Winner',
        award_type: 'Kennerspiel des Jahres',
        description: 'Connoisseur Game of the Year from Germany',
      ...
      {
        name: '2019 Golden Geek Board Game of the Year Winner',
        year: 2019,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Board Game of the Year from BoardGameGeek community',
  ...
  // === ROLL & WRITE ===
  {
    ...
    honors: [
      {
        name: '2018 Golden Geek Best Family Board Game Winner',
        year: 2018,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best Family Board Game from BoardGameGeek community',
  ...
  },
  {
    ...
    honors: [
      {
        name: '2014 Golden Geek Best 2-Player Board Game Winner',
        year: 2014,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Best 2-Player Board Game from BoardGameGeek community',
  ...
  // === LEGACY GAMES ===
  {
    ...
    honors: [
      ...
      {
        name: '2015 Golden Geek Most Innovative Board Game Winner',
        year: 2015,
        category: 'Winner',
        award_type: 'Golden Geek',
        description: 'Most Innovative Board Game from BoardGameGeek community',
      },
    ],
  },
]
...
async function fetchBGGData(gameIds, attempt = 0) {
  ...
  try {
    console.log(
      `📡 API Request ${stats.apiRequests + 1}: ${gameIds.length} games (attempt ${attempt + 1})`
    )
    ...
    console.error(
      `❌ API request failed (attempt ${attempt + 1}): ${error.message}`
    )
...
function parseGameDataWithHonors(xml, honorsMap) {
  try {
    ...
    for (const item of items) {
      ...
      const primaryName =
        nameArray.find((n) => n['@_type'] === 'primary')?.['@_value'] ||
        'Unknown'
...
async function processGamesWithHonors(gameData) {
  ...
  for (const game of gameData) {
    if (existingBggIds.has(game.bgg_id)) {
      ...
      for (const newHonor of game.honors) {
        if (
          !allHonors.some(
            (h) => h.name === newHonor.name && h.year === newHonor.year
          )
        ) {
  ...
  if (gamesToUpdate.length > 0) {
    console.log(
      `📝 Updating ${gamesToUpdate.length} existing games with honors...`
    )
    ...
    for (const gameUpdate of gamesToUpdate) {
      ...
      if (updateError) {
        console.error(
          `❌ Failed to update game ${gameUpdate.bgg_id}:`,
          updateError
        )
        stats.failedGames++
      } else {
  ...
  if (gamesToInsert.length > 0) {
    ...
    if (insertError) {
      ...
      stats.honorsAdded += gamesToInsert.reduce(
        (sum, g) => sum + g.honors.length,
        0
      )
    }
  }
  ...
  console.log(
    `✅ Processed: ${gamesToUpdate.length} updated, ${gamesToInsert.length} inserted`
  )
}
...
async function saveProgress(currentIndex) {
  ...
  try {
    ...
    console.log(
      `💾 Progress saved (processed ${stats.processedGames}/${stats.totalGames} games)`
    )
  } catch (error) {
...
async function loadProgress() {
  try {
    ...
    console.log(
      `   Processed: ${progress.stats.processedGames}/${progress.stats.totalGames}`
    )
...
function displayProgress() {
  ...
  console.log(
    `   Processed: ${stats.processedGames} (${((stats.processedGames / stats.totalGames) * 100).toFixed(1)}%)`
  )
...
async function importHonorsData() {
  ...
  try {
    ...
    if (
      schemaError &&
      schemaError.message.includes('column "honors" does not exist')
    ) {
    ...
    console.log(
      `🎯 Processing ${gamesToProcess.length} games starting from index ${startIndex}\n`
    )
    ...
    console.log(
      `📦 Created ${batches.length} batches of up to ${CONFIG.BATCH_SIZE} games each\n`
    )
    ...
    for (let batchIndex = 0; batchIndex < batches.length; batchIndex++) {
      ...
      console.log(
        `   Games: ${batch.map((g) => `${g.name} (${g.bgg_id})`).join(', ')}`
      )
      ...
      try {
        ...
        if (batchIndex < batches.length - 1) {
          console.log(
            `⏳ Waiting ${CONFIG.REQUEST_DELAY / 1000} seconds before next batch...`
          )
        ...
        if (batchIndex < batches.length - 1) {
          console.log(
            `⏳ Waiting ${(CONFIG.REQUEST_DELAY * 2) / 1000} seconds before retry...`
          )
    ...
    if (stats.failures.length > 0) {
      ...
      stats.failures.forEach((failure) => {
        console.log(
          `   ${failure.bgg_id} (${failure.name || 'Unknown'}): ${failure.error}`
        )
      })

      // Save failures to file
      await fs.writeFile(
        'honors-import-failures.json',
        JSON.stringify(stats.failures, null, 2)
      )
