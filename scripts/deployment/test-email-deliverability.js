  ...
  for (const email of TEST_EMAILS) {
    ...
    try {
      ...
      if (signupError) {
        ...
        console.log(`    ✅ Signup confirmation sent (${testResult.timing.signup}ms)`)
      }
      ...
      if (resetError) {
        ...
        testResult.tests.passwordReset = 'Success - Check inbox for password reset'
        console.log(`    ✅ Password reset sent (${testResult.timing.passwordReset}ms)`)
      }
...
async function testDNSRecords() {
  ...
  try {
    ...
    console.log('💡 You can manually check DNS records at: https://mxtoolbox.com/')
  }
}
