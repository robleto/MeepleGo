...
async function run(){
  const patterns=['Golden Elephant%','The Golden Elephant%','Golden Elephant Award%','The Golden Elephant Award%'];
  const rows=new Map();
  ...
  if(!list.length){console.log('No Golden Elephant placeholders found.');return;}
